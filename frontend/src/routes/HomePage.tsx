  ...
  return (
    <div className="min-h-screen bg-void-950 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        {/* Footer with Lab link */}
        <div className="absolute bottom-8 text-center">
          <p className="text-void-600 text-sm mb-3">輸入關鍵字開始搜尋，或點擊熱門搜尋快速探索</p>
          <Link
            to="/lab/search-modes"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-void-800/30 border border-void-700/30 text-void-400 text-sm hover:bg-cosmos-500/10 hover:border-cosmos-500/30 hover:text-cosmos-300 transition-all"
          >
